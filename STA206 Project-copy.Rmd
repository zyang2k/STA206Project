...
```{r}
summary(plasma$retplasma)
plot(hist(plasma$retplasma))
summary(plasma$betaplasma)
plot(hist(plasma$betaplasma))
```
...
```{r}
rdt<-lm(log(retplasma)~vituse+calories+fat+fiber+alcohol+cholesterol+retdiet+betadiet,data=plasma)
bdt<-lm(log(betaplasma)~vituse+calories+fat+fiber+alcohol+cholesterol+retdiet+betadiet,data=plasma)
